...
public class LibraryValidation {
	public boolean validateId(String id) {
		...
		if (matcher.matches())
			...
			throw new LibraryExceptions("Enter Valid Id");
	}
	...
	public boolean validateName(String name) {
		...
		if (matcher.matches())
			...
			throw new LibraryExceptions("Enter Valid Name");
	}
	...
	public boolean validateEmail(String email) {
		...
		if (matcher.matches())
			...
			throw new LibraryExceptions("Enter Valid Email Id");
	}
	...
	public boolean validatePassword(String pwd) {
		...
		if (matcher.matches())
			...
			throw new LibraryExceptions("Enter Valid Password");
